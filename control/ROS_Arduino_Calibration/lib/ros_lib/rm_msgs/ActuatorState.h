...
namespace rm_msgs
{
  ...
  class ActuatorState : public ros::Msg
  {
    public:
      ...
      typedef float _executed_effort_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (this->frequency_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->frequency[i]);
      }
      ...
      *(outbuffer + offset + 3) = (this->executed_effort_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->executed_effort[i]);
      }
      ...
      *(outbuffer + offset + 3) = (this->offset_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->offset[i]);
      }
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      for( uint32_t i = 0; i < frequency_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_frequency));
      ...
      if(executed_effort_lengthT > executed_effort_length)
        this->executed_effort = (float*)realloc(this->executed_effort, executed_effort_lengthT * sizeof(float));
      executed_effort_length = executed_effort_lengthT;
      for( uint32_t i = 0; i < executed_effort_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_executed_effort));
        memcpy( &(this->executed_effort[i]), &(this->st_executed_effort), sizeof(float));
      }
      ...
      for( uint32_t i = 0; i < offset_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_offset));
