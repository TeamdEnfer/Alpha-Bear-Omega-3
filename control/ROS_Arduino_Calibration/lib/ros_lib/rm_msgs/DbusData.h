...
namespace rm_msgs
{
  ...
  {
    public:
      typedef float _ch_l_x_type;
      _ch_l_x_type ch_l_x;
      typedef float _ch_l_y_type;
      _ch_l_y_type ch_l_y;
      typedef float _ch_r_x_type;
      _ch_r_x_type ch_r_x;
      typedef float _ch_r_y_type;
      _ch_r_y_type ch_r_y;
      typedef uint8_t _s_l_type;
      _s_l_type s_l;
      typedef uint8_t _s_r_type;
      _s_r_type s_r;
      typedef float _wheel_type;
      _wheel_type wheel;
    ...
    {
      int offset = 0;
      offset += serializeAvrFloat64(outbuffer + offset, this->ch_l_x);
      offset += serializeAvrFloat64(outbuffer + offset, this->ch_l_y);
      offset += serializeAvrFloat64(outbuffer + offset, this->ch_r_x);
      offset += serializeAvrFloat64(outbuffer + offset, this->ch_r_y);
      *(outbuffer + offset + 0) = (this->s_l >> (8 * 0)) & 0xFF;
      offset += sizeof(this->s_l);
      *(outbuffer + offset + 0) = (this->s_r >> (8 * 0)) & 0xFF;
      offset += sizeof(this->s_r);
      offset += serializeAvrFloat64(outbuffer + offset, this->wheel);
      offset += serializeAvrFloat64(outbuffer + offset, this->m_x);
      offset += serializeAvrFloat64(outbuffer + offset, this->m_y);
      offset += serializeAvrFloat64(outbuffer + offset, this->m_z);
      union {
        bool real;
        uint8_t base;
      } u_p_l;
    ...
    {
      int offset = 0;
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->ch_l_x));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->ch_l_y));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->ch_r_x));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->ch_r_y));
      this->s_l =  ((uint8_t) (*(inbuffer + offset)));
      offset += sizeof(this->s_l);
      this->s_r =  ((uint8_t) (*(inbuffer + offset)));
      offset += sizeof(this->s_r);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->wheel));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->m_x));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->m_y));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->m_z));
      union {
        bool real;
        uint8_t base;
      } u_p_l;
