...
static const char ROBOT_WAIT_FOR_USER_INPUT_EVENT[] = "webots_ros/robot_wait_for_user_input_event";
  ...
  class robot_wait_for_user_input_eventRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return ROBOT_WAIT_FOR_USER_INPUT_EVENT; };
    virtual const char * getMD5() override { return "3e70b4ac6cfb42776e6d4bc21b66e815"; };
  ...
  class robot_wait_for_user_input_eventResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return ROBOT_WAIT_FOR_USER_INPUT_EVENT; };
    virtual const char * getMD5() override { return "b2a9c605bb7a420089b02c6063322298"; };
