...
static const char LIDAR_GET_LAYER_POINT_CLOUD[] = "webots_ros/lidar_get_layer_point_cloud";
  ...
  class lidar_get_layer_point_cloudRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return LIDAR_GET_LAYER_POINT_CLOUD; };
    virtual const char * getMD5() override { return "0d6c1c0236296850b6361a672e8a61c4"; };
  ...
  class lidar_get_layer_point_cloudResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return LIDAR_GET_LAYER_POINT_CLOUD; };
    virtual const char * getMD5() override { return "e08e3c13c98d23184c44ac2bd82ce8b4"; };
