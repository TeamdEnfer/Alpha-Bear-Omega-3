#ifndef _ROS_SERVICE_node_enable_pose_tracking_h
#define _ROS_SERVICE_node_enable_pose_tracking_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char NODE_ENABLE_POSE_TRACKING[] = "webots_ros/node_enable_pose_tracking";

  class node_enable_pose_trackingRequest : public ros::Msg
  {
    public:
    ...
    node_enable_pose_trackingRequest():
      node(0),
      sampling_period(0),
      from_node(0)
    {
    ...
    virtual const char * getType() override { return NODE_ENABLE_POSE_TRACKING; };
    virtual const char * getMD5() override { return "acb2c210846725d8c180a233b1c72648"; };

  };

  class node_enable_pose_trackingResponse : public ros::Msg
  {
    public:
      typedef int8_t _success_type;
      _success_type success;

    node_enable_pose_trackingResponse():
      success(0)
    {
    }
  ...
  class node_enable_pose_tracking {
    public:
