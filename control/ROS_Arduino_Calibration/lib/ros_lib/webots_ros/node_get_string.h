#ifndef _ROS_SERVICE_node_get_string_h
#define _ROS_SERVICE_node_get_string_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char NODE_GET_STRING[] = "webots_ros/node_get_string";

  class node_get_stringRequest : public ros::Msg
  {
    public:
      typedef uint64_t _node_type;
      _node_type node;

    node_get_stringRequest():
      node(0)
    {
    }
    ...
    virtual const char * getType() override { return NODE_GET_STRING; };
    virtual const char * getMD5() override { return "364f76d0680a5475664d98abd705f036"; };

  };

  class node_get_stringResponse : public ros::Msg
  {
    public:
      typedef const char* _value_type;
      _value_type value;

    node_get_stringResponse():
      value("")
    {
    }
