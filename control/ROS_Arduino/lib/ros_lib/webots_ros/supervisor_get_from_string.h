#ifndef _ROS_SERVICE_supervisor_get_from_string_h
#define _ROS_SERVICE_supervisor_get_from_string_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SUPERVISOR_GET_FROM_STRING[] = "webots_ros/supervisor_get_from_string";

  class supervisor_get_from_stringRequest : public ros::Msg
  {
    public:
      typedef const char* _value_type;
      _value_type value;

    supervisor_get_from_stringRequest():
      value("")
    {
    }
    ...
    virtual const char * getType() override { return SUPERVISOR_GET_FROM_STRING; };
    virtual const char * getMD5() override { return "64e58419496c7248b4ef25731f88b8c3"; };

  };

  class supervisor_get_from_stringResponse : public ros::Msg
  {
    public:
      typedef uint64_t _node_type;
      _node_type node;

    supervisor_get_from_stringResponse():
      node(0)
    {
    }
  ...
  class supervisor_get_from_string {
    public:
