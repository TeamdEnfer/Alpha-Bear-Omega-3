#ifndef _ROS_SERVICE_field_get_name_h
#define _ROS_SERVICE_field_get_name_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_GET_NAME[] = "webots_ros/field_get_name";

  class field_get_nameRequest : public ros::Msg
  {
    public:
      typedef uint64_t _field_type;
      _field_type field;

    field_get_nameRequest():
      field(0)
    {
    }
    ...
    virtual const char * getType() override { return FIELD_GET_NAME; };
    virtual const char * getMD5() override { return "6e05f2ccbc5e22655a0890e2557862bd"; };

  };

  class field_get_nameResponse : public ros::Msg
  {
    public:
      typedef const char* _name_type;
      _name_type name;

    field_get_nameResponse():
      name("")
    {
    }
