...
*/
	...
	//Rear Left
        messageCommand.data[6]=(abs((champ_cmd.points[0].positions[6]+OFFSET_69)*RAD2DEG))-9.88;//Shoulder
	...
	//Rear Right
        ...
        /*
        messageCommand.data[0]=(abs((-champ_cmd.points[0].positions[0]+OFFSET_03)*RAD2DEG))+3.12;
        ...
        messageCommand.data[4]=(-0.3593*pow(champ_cmd.points[0].positions[4],2)+0.6064*champ_cmd.points[0].positions[4]+2.375)*RAD2DEG + 4.98;  
        ...
        messageCommand.data[6]=(abs((champ_cmd.points[0].positions[6]+OFFSET_69)*RAD2DEG))-9.88;
        messageCommand.data[7]=(0.3408*pow(champ_cmd.points[0].positions[7],2)-0.6434*(champ_cmd.points[0].positions[7])+0.0095)*RAD2DEG +3.43;
        ...
        messageCommand.data[9]=(abs((champ_cmd.points[0].positions[9]+OFFSET_69)*RAD2DEG))+1.1;
